...
namespace MundoCanjeWeb.Models
{
    ...
    public partial class Usuarios
    {
        public Usuarios()
        {
            ...
            this.Chats_Detalles1 = new HashSet<Chats_Detalles>();
            this.Pedidos = new HashSet<Pedidos>();
            this.Productos = new HashSet<Productos>();
            this.Usuarios_Categorias = new HashSet<Usuarios_Categorias>();
        }
        ...
        public virtual ICollection<Chats_Detalles> Chats_Detalles1 { get; set; }
        public virtual Localidades Localidades { get; set; }
        public virtual ICollection<Pedidos> Pedidos { get; set; }
        public virtual Planes Planes { get; set; }
        public virtual ICollection<Productos> Productos { get; set; }
        public virtual Usuarios_Tipos Usuarios_Tipos { get; set; }
        public virtual ICollection<Usuarios_Categorias> Usuarios_Categorias { get; set; }
    }
}
